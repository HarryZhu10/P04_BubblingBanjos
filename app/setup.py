import sqlite3, csv, sqlalchemy, gdown, shapefile, fiona, pyproj #gdown for downloading big google drive files
import pandas as pd
...
with fiona.open('zip://ZIP_CODE_040114.zip') as src:
    ...
    for feature in src:
        ...
        testcord = testgeo['coordinates'][0]
        new_cords = [transformer.transform(x, y) for x, y in testcord]
        lon, lat = new_cords
        print(lon + " " + lat)
